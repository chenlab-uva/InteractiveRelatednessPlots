ui <- fluidPage(
  ...
  sidebarLayout(position = "left",
                sidebarPanel(id = "sidebar", strong("Step1: Please prepare KING roh output files and then"),
                             actionButton(inputId = "filechoose", label = "Choose *.roh file"),
                             textInput(inputId = "FID", label = "Optional Step2: please type a Family ID or select all samples", value = "All"),
